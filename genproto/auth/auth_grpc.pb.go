...
type AuthServiceClient interface {
	...
	ChangeRole(ctx context.Context, in *Role, opts ...grpc.CallOption) (*Void, error)
}
...
func (c *authServiceClient) ChangeRole(ctx context.Context, in *Role, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
...
type AuthServiceServer interface {
	...
	ChangeRole(context.Context, *Role) (*Void, error)
...
func (UnimplementedAuthServiceServer) ChangeRole(context.Context, *Role) (*Void, error) {
